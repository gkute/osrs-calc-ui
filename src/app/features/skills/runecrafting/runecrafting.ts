...
@Component({
  ...
  templateUrl: './runecrafting.html',
  styleUrl: './runecrafting.scss',
})
export class Runecrafting implements OnInit {
  ...
  ngOnInit(): void {
    this.skillDataService.getSkillQuests('runecrafting').subscribe({
